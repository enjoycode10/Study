package com.okgo.alipay.controller;
...
import com.okgo.alipay.config.AlipayProperties;
import com.okgo.alipay.utils.PayUtil;
...
public class AlipayF2FController {
    ...
    public String barCodePay(String authCode) {
        ...
        // (必填) 订单标题，粗略描述用户的支付目的。如“全家（浦东店）消费”
        String subject = "测试订单";
        ...
        String storeId = "2088102180912585";
